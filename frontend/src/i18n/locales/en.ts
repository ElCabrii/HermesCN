...
export const en = {
  ...
  // ── slash commands (plan Task 8.7; ported from static/commands.js + static/i18n.js) ──
  ...
  model_did_you_mean: " — did you mean \"{0}\"?",
  ...
  goal_status_active: "⊙ Goal (active, {0}/{1} turns): {2}",
  goal_status_paused: "⏸ Goal (paused, {0}/{1}{2}): {3}",
  goal_status_done: "✓ Goal done ({0}/{1}): {2}",
  goal_set: "⊙ Goal set ({0}-turn budget): {1}",
  goal_paused: "⏸ Goal paused: {0}",
  goal_resumed: "▶ Goal resumed: {0}",
  goal_cleared: "Goal cleared.",
  goal_no_goal: "No active goal.",
  goal_achieved: "✓ Goal achieved: {0}",
  goal_paused_budget_exhausted: "⏸ Goal paused — {0}/{1} turns used. Use /goal resume to keep going, or /goal clear to stop.",
  goal_continuing: "↻ Continuing toward goal ({0}/{1}): {2}",
  session_title_regenerated: "Title regenerated: {0}",
